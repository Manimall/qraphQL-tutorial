...
class MoviesForm extends React.Component {
  ...
  handleSave = () => {
    ...
    id
      ? updateMovie({ id, name, genre, rate: Number(rate), directorId, isWatched: Boolean(isWatched) })
      : addMovie({ name, genre, rate: Number(rate), directorId, isWatched: Boolean(isWatched) });
